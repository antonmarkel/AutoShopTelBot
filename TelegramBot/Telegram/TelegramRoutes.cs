                ...
                case "main/info":
                    {
                        ...
                        await _botClient.SendPhoto(chat, Resources.Resources.MainPict, caption: $"💾 Информация о нашем магазине:", replyMarkup: inlineKeyboard);
                        return;
                    }
                case "main/rules":
                    {
                ...
                case "main":
                    {
                        ...
                        await _botClient.SendPhoto(chat,Resources.Resources.MainPict, caption: "👋 Магазин Lancaster Shop к вашим услугам", replyMarkup: inlineKeyboard);
                        return;
                    }
                          ...
                          new List<InlineKeyboardButton[]>()
                           {
                                ...
                                new InlineKeyboardButton[]
                                 ...
                                 new InlineKeyboardButton[]
                                 {
                                    InlineKeyboardButton.WithCallbackData("Сбер","main/pay/sber"),
                                 },
                                 new InlineKeyboardButton[]
                                 {
                ...
                case "main/itemsPrev":
                    {
                        ...
                        await _botClient.SendPhoto(chat, Resources.Resources.ItemsPict, caption: "🗳️ Выберите категорию:", replyMarkup: inlineKeyboard);
